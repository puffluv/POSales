    ...
    public partial class Recept : Form
    {
        ...
        public void LoadRecept(string pcash, string pchange)
        {
            ...
            try
            {
                ...
                ReportParameter pVatable = new ReportParameter("pVatable", ".");
                ReportParameter pVat = new ReportParameter("pVat", ".");
                ReportParameter pDiscount = new ReportParameter("pDiscount", ".");
                ...
                ReportParameter pTransaction = new ReportParameter("pTransaction", "Счет №: " + cashier.lblTranNo.Text);
